  ...
  return (
    <Layout canGoBack>
      <div className="space-y-4 px-4 py-10">
        ...
        <h3 className="mt-2 text-xl font-semibold text-gray-800">Galaxy S50</h3>
        <p className="mt-3 block text-2xl text-gray-900">$140</p>
        ...
        <div className="fixed inset-x-0 bottom-4 mx-auto w-full max-w-md">
          <div className="relative flex items-center">
            ...
            <div className="absolute inset-y-0 right-0 flex py-1.5 pr-1.5">
              <button className="flex items-center rounded-full bg-orange-500 px-3 text-sm text-white transition-colors hover:bg-orange-600 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2">
                &rarr;
              </button>
            </div>
          </div>
